...
public class WorkoutController {
    ...
    private static final String WORKOUT_DATA_NOT_FOUND= "Could not find the workout assocatied with the id";
...
//TODO Complete the workout repo and service class
    ...
    //Create new Workout
    @PostMapping("/workout")
    public Workout createWorkoutData(@Validated @RequestBody Workout workout,WorkoutRecord workoutRecord){
